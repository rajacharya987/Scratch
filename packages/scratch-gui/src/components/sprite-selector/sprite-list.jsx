                    ...
                    return (
                        ...
                        >
                            <ThrottledSpriteSelectorItem
                                ...
                                mesh={sprite.mesh}
                                customMesh={sprite.customMesh}
                                materialAlbedo={sprite.material3d && sprite.material3d.albedo}
...
SpriteList.propTypes = {
    ...
    items: PropTypes.arrayOf(PropTypes.shape({
        ...
        material3d: PropTypes.shape({
            albedo: PropTypes.arrayOf(PropTypes.number)
        }),
        name: PropTypes.string.isRequired,
