...
class CostumeTab extends React.Component {
    ...
    handleCostumeUpload (e) {
        ...
        handleFileUpload(e.target, (buffer, fileType, fileName, fileIndex, fileCount, fullFileName) => {
            ...
            }, this.props.onCloseImporting, fullFileName);
        }, this.props.onCloseImporting);
    }
    handleFileUploadClick () {
            ...
            <AssetPanel
                ...
                buttons={[
                    ...
                    },
                    {
                        ...
                        fileAccept: '.svg, .png, .bmp, .jpg, .jpeg, .gif, .glb, .gltf, .obj, .fbx, .stl, .dae, .ply, .3ds',
