...
import {renderMeshThumbnail} from '../../../scratch-render/src/unified/mesh-thumbnail';
...
class SpriteSelectorItem extends React.PureComponent {
    ...
    getCostumeData () {
        ...
        if (this.props.customMesh || this.props.mesh) {
            const thumb = renderMeshThumbnail(this.props.customMesh || this.props.mesh, this.props.materialAlbedo);
...
SpriteSelectorItem.propTypes = {
    ...
    materialAlbedo: PropTypes.arrayOf(PropTypes.number),
