...
import threeDIconURL from './threed/threed.svg';
import threeDInsetIconURL from './threed/threed-small.svg';
...
export default [
    {
        name: (
            <FormattedMessage
                defaultMessage="3D"
                description="Name for the 3D world extension"
                id="gui.extension.threed.name"
            />
        ),
        extensionId: 'threed',
        iconURL: threeDIconURL,
        insetIconURL: threeDInsetIconURL,
        description: (
            <FormattedMessage
                defaultMessage="Make 3D games on the same stage. Cubes, cameras, lights, and .glb models."
