...
const alerts = [
    ...
    {
        alertId: 'shareSuccess',
        alertType: AlertTypes.STANDARD,
        clearList: ['shareSuccess', 'sharing', 'shareError'],
        content: (
            <FormattedMessage
                defaultMessage="Your project is now shared. Anyone with the link can view it."
                description="Message shown after sharing a project like on scratch.mit.edu"
                id="gui.alerts.sharesuccess"
            />
        ),
        iconURL: successImage,
        level: AlertLevels.SUCCESS,
    ...
    },
    {
        ...
        content: (
            <FormattedMessage
                ...
                description="Message indicating that the project is being shared"
                id="gui.alerts.sharing"
            />
        ),
        iconSpinner: true,
        level: AlertLevels.SUCCESS
    },
    {
        ...
        content: (
            <FormattedMessage
                ...
                description="Message indicating that sharing failed"
                id="gui.alerts.shareerror"
            />
        ),
        level: AlertLevels.WARN
    },
