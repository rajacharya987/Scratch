...
import {loadSharedProjectBytes} from './local-project-store';
...
const ProjectFetcherHOC = function (WrappedComponent) {
    class ProjectFetcherComponent extends React.Component {
        ...
        fetchProject (projectId, loadingState) {
            ...
            const sharedId = projectId && String(projectId) !== '0';
            const sharedLoad = sharedId ?
                loadSharedProjectBytes(projectId).then(bytes => {
                    if (bytes) {
